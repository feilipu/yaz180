...
```bash
> zcc +yaz180 -subtype=rom -SO3 -v -m -clib=sdcc_iy -llib/yaz180/ff -llib/yaz180/time --list --c-code-in-asm --max-allocs-per-node20000 @yabios.lst -gpf yabios.rex -o yabios -create-app
```
