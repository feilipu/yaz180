...
- [ ] add flash support into `_ memcpy_far` or similar
- [ ] integrate CLI support
...
`far void *memcpy_far(far void *str1, const far void *str2, size_t n)`<br>
...
`far void *memset_far(far void *str, int c, size_t n)`<br>
