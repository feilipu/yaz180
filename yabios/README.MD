...
This example would be notated as `0xEE = 4E`<br>
<br>
Far pointers will normally be passed in the `EHL` registers, as is the z88dk standard.<br>
`0xEE` is the bank address, as defined above, as `bAAAA.RRRR`.<br>
