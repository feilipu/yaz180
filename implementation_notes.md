...
```bash
> zcc +yaz180 -subtype=rom -SO3 -v -m -clib=sdcc_iy -llib/yaz180/ff -llib/yaz180/time --math32 --max-allocs-per-node2000000 @yabios.lst -gf yabios.rex -o yabios -create-app
```
