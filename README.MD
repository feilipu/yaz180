...
Work in progress. Currently the console I/O for is complete, as is the underlying disk sub-system. The remaining work is to create CP/M disks as Fat32 files.
